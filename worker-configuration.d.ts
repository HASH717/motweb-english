/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: abdb67456bd7462b7fa6b61bf8258f0a)
// Runtime types generated with workerd@1.20260521.1 2026-08-03 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	NEXT_PUBLIC_TURNSTILE_SITE_KEY: "0x4AAAAAADWOtryhjyNe5Wt0";
	NEXT_PUBLIC_WHATSAPP_NUMBER: "213559086142";
	NEXT_PUBLIC_SITE_URL: "https://motweb-english.pages.dev";
	CHARGILY_CHECKOUT_URL: "https://pay.chargily.net/api/v2/checkouts";
	CHARGILY_PUBLIC_KEY: "live_pk_RFLN32ZraydG2c34G6a0GlfAwfbxlKXD1aaQfdNp";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_TURNSTILE_SITE_KEY" | "NEXT_PUBLIC_WHATSAPP_NUMBER" | "NEXT_PUBLIC_SITE_URL" | "CHARGILY_CHECKOUT_URL" | "CHARGILY_PUBLIC_KEY">> {}
}

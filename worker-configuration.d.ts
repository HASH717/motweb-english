/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 88d3e6b63c023288ec543ab0e60ec525)
// Runtime types generated with workerd@1.20260521.1 2026-08-04 nodejs_compat
interface __BaseEnv_Env {
	EBOOKS_KV: KVNamespace;
	DB: D1Database;
	ASSETS: Fetcher;
	NEXT_PUBLIC_WHATSAPP_NUMBER: "213559086142";
	NEXT_PUBLIC_SITE_URL: "https://motweb-english.motraxagency.workers.dev";
	OGADS_API_ENDPOINT: "https://saveapp.store/api/v2";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_WHATSAPP_NUMBER" | "NEXT_PUBLIC_SITE_URL" | "OGADS_API_ENDPOINT">> {}
}
